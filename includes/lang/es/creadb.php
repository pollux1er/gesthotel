...
case "I dati inseriti non sono esatti o il database non è in ascolto (se postgres assicurarsi che venga avviato con -i e di avere i permessi giusti in pg_hba.conf)": 						$messaggio = "Los datos insertados no son exactos o la base de datos no está a la escucha (si es postgresql asegurarse que sea arrancado con -i y tener los permisos necesarios en pg_hba.conf)"; break;
