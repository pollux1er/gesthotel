...
case "Ripeti la password":  			$messaggio = "repeter mot de passe"; break;
...
case "Nuova password":  			$messaggio = "noouveau mot de passe"; break;
case "Gestione degli utenti di hoteldruid":	$messaggio = " gestion d'utilisateur de Hotel Barcelont"; break;
...
case "Amministratore":  			$messaggio = "Administratoeu"; break;
...
case "Esiste già un gruppo chiamato":  		$messaggio = "un nom de groupe existe deja"; break;
case "Modifica":  				$messaggio = "Modifier"; break;
case "cancella":  				$messaggio = "supprimer"; break;
case "Si è sicuri di voler <b style=\"font-weight: normal; color: red;\">cancellare</b> l'utente":	$messaggio = "etes vous sur de vouloir <b style=\"font-weight: normal; color: red;\">supprimer</b> utilisateur"; break;
