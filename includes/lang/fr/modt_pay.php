...
case "Pagina per prenotazioni con PayPal":	$messaggio = "Page to book with PayPal"; $tr = 1; break;
case "Crea la pagina per le prenotazioni con PayPal":	$messaggio = "Create the PayPal booking page"; $tr = 1; break;
...
case "Controllo Disponibilità":  	$messaggio = "Availability Check"; $tr = 1; break;
case "Inserimento Dati":  		$messaggio = "Data Insertion"; $tr = 1; break;
case "Verifica Email":  		$messaggio = "Email Validation"; $tr = 1; break;
case "Pagamento Caparra":  		$messaggio = "Deposit Payment"; $tr = 1; break;
case "Pagina prenotazione immediata":	$messaggio = "Instant booking page"; $tr = 1; break;
case "Testo dell'email di conferma prenotazione":	$messaggio = "Text of the email that confirms reservation"; $tr = 1; break;
case "documento":  			$messaggio = "documento"; $tr = 1; break;
case "email predefinita":  		$messaggio = "default email"; $tr = 1; break;
...
case "mdl_prenotazione_immediata.php":	$messaggio = "fr_instant_booking_tpl.php"; $tr = 1; break;
