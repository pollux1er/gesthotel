...
case "La città di residenza verrà cambiata da":	$messaggio = "la ville de la résidence sera changée en"; break;
case "La nazione di residenza verrà cambiata da":	$messaggio = "la nation de la résidence sera changée en"; break;
case "Il CAP verrà cambiato da":  		$messaggio = "le code postal sera changé en"; break;
case "Il fax verrà cambiato da":  		$messaggio = "le fax sera changé en"; break;
case "L' email verrà cambiata da":  		$messaggio = "l'email sera changé den"; break;
case "Il 2° telefono verrà cambiato da":  	$messaggio = "le 2ème téléphone sera changé en"; break;
case "Il 3° telefono verrà cambiato da":  	$messaggio = "le 3ème téléphone sera changé en"; break;
...
case "La <b>città di residenza</b> verrà cancellata":	$messaggio = "la <b>ville de résidence</b> > sera supprimé"; break;
...
case "Il <b>2° telefono</b> verrà cancellato":	$messaggio = "le <b>2ième téléphone</b> > sera supprimé"; break;
case "Il <b>3° telefono</b> verrà cancellato":	$messaggio = "le <b>3ième téléphone</b> > sera supprimé"; break;
...
case "Città di residenza":  			$messaggio = "ville de résidence"; break;
...
case "3° telefono":  				$messaggio = "3ièmé téléphone"; break;
...
case "Reg./Prov. di residenza":  		$messaggio = "Région de résidence"; break;
case "Documento":  				$messaggio = "Document"; break;
case "Scadenza documento":  			$messaggio = "expiration du document"; break;
case "La regione di residenza verrà cambiata da":	$messaggio = "la région de la résidence sera changée en"; break;
...
case "La <b>regione di residenza</b> verrà cancellata":	$messaggio = "la <b>région de résidence</b> sera supprimée"; break;
case "Il <b>documento</b> verrà cancellato":  	$messaggio = "le <b>document</b> sera supprimé"; break;
case "La <b>data di scadenza del documento</b> verrà cancellata":	$messaggio = "la <b>date d'expiration du document</b> sera supprimée"; break;
...
case "Città di rilascio":  			$messaggio = "la ville libérante"; break;
case "Reg./Prov. di rilascio":  		$messaggio = "la region libérante"; break;
case "Nazione di rilascio":  			$messaggio = "la nation libérante"; break;
case "La cittadinanza verrà cambiata da":  	$messaggio = "la nationalité sera changée en"; break;
case "La nazione di nascita verrà cambiata da":	$messaggio = "la nation de la naissance sera changée en"; break;
case "La regione di nascita verrà cambiata da":	$messaggio = "la région de la naissance sera changée en"; break;
case "La città di nascita verrà cambiata da":	$messaggio = "la ville de la naissance sera changée en"; break;
case "La città di rilascio del documento verrà cambiata da":	$messaggio = "la ville libérant le document sera changée en"; break;
case "La regione/provincia di rilascio del documento verrà cambiata da":	$messaggio = "la région libérant le document sera changée en"; break;
case "La nazione di rilascio del documento verrà cambiata da":	$messaggio = "la nation libérant le document sera changée en"; break;
...
case "La <b>città di rilascio del documento</b> verrà cancellata":	$messaggio = "la <b>ville libérante dudocument</b> sera supprimée"; break;
