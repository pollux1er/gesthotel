...
<input type=\"hidden\" name=\"tipo_commento$n_t\" value=\"".${"tipo_commento".$n_t}."\">";
if (!@get_magic_quotes_gpc()) $mess_dati_form .= "<input type=\"hidden\" name=\"commento$n_t\" value=\"".htmlspecialchars(${"commento".$n_t})."\">";
else $mess_dati_form .= "<input type=\"hidden\" name=\"commento$n_t\" value=\"".htmlspecialchars(stripslashes(${"commento".$n_t}))."\">";
