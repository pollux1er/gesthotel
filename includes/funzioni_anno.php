...
if ($PHPR_DB_TYPE == "mysql") @esegui_query("SET default_storage_engine=MYISAM",1);
...
$col_tableregole = "idregole integer, app_agenzia varchar(100), tariffa_per_app text, tariffa_per_utente text, tariffa_per_persone text, tariffa_commissioni integer, iddatainizio integer, iddatafine integer, motivazione text, motivazione2 text";
...
$tabelle_lock = array($tableanni,$tableprenotazioni,$tablecostiprenota,$tablerclientiprenota,$tablenometariffe,$tableperiodi,$tablecosti,$tableregole,$tablesoldi,$tablepersonalizza,$tableprivilegi,$tabletransazioni);
if ($importa_anno_prec == "SI") {
$anno_prec = $anno - 1;
$tablenometariffe_prec = $PHPR_TAB_PRE."ntariffe".$anno_prec;
...
# aggiorno i numeri delle prenotazioni importate nei nomi dei documenti già creati nel nuovo annoù
