...
<input type=\"hidden\" name=\"c_nome\" value=\"$c_nome\">
...
<tr style=\"background-color: ".rowbgcolor().";\"><td>".mex("CVC",$pag).": <b>$d_cvc_cc</b></td>
<td>".mex("cambia in",$pag).": 
...
<div style=\"clear: both; padding: 6px 0 0 0;\">".mex("Commento",$pag).":<div>
...
<input class=\"sbutton\" id=\"modi\" type=\"submit\" name=\"modifica_cliente\" value=\"".mex("Modifica i dati del cliente",$pag)."\">
</div></div></form>";
