...
$celle = 1;
$num_colonne = 3;
$regole = esegui_query("select * from $tableregole_mostra where app_agenzia != '' order by app_agenzia");
...
echo "<table><tr><td style=\"width: 130px;\">
".str_replace(" ","&nbsp;",mex("Applica la regola 1",$pag)).":</td>
