...
$dati_ca = dati_costi_agg_ntariffe($tablenometariffe,"");
...
echo ".<br>";
if ($occupare_app_agenzia_sempre == "SI" and !$app_richiesti[',numero,']) {
echo mex("Si dovrà occupare almeno un periodo della regola di assegnazione 1",$pag).".<br>";
} # fine if ($occupare_app_agenzia_sempre == "SI" and !$app_richiesti[",numero,"])
...
$dati_osp .= "<input name=\"ospite_".$idcognome[$num]."_".$id_clienti_comp."\" value=\"SI\" type=\"checkbox\">\
...
$dati_osp .= "".addslashes(mex("nella prenotazione",$pag))."\
 <select name=\"pren_osp_".$idcognome[$num]."_".$id_clienti_comp."\">\
$select_prenotazioni\
</select><br>";
} # fine if ($num_tipologie > 1 or $num_app_richiesti1 > 1)
else $dati_osp .= "<input type=\"hidden\" name=\"pren_osp_".$idcognome[$num]."_".$id_clienti_comp."\" value=\"p1_1\"><br>";
} # fine for $num1
echo ".
